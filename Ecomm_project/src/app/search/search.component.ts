...
export class SearchComponent implements OnInit{
  ...
  ngOnInit(){
    ...
    /*       ActivatedRoute: This is an Angular service that represents the currently activated route. 
          It contains information about the route associated with the component. You inject ActivatedRoute into your component to access this information.
